...
class EmotionServiceImplTest {
    ...
    void setup() {
        Member member1 = memberRepository.save(
                makeMember("홍길동", "gil@gmail.com", "1q2w3e4r", "2000-01-01"));
    ...
    void analyzeDiaryTest() {
        ...
        System.out.println(savedDiary.getId());

        Diary diary1 = diaryRepository.findById(savedDiary.getId()).orElseThrow();
        System.out.println(diary1.getContent());
        System.out.println(diary1.getDiaryEmotion());
    }
